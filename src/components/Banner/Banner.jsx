        ...
        <div className="min-h-[550px] flex justify-center items-center backdrop-blur-xl py-12 sm:py-0 ">
          <div data-aos="slide-up" data-aos-duration="300" className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {/* Image section */}
              <img src={BiryaniImg} alt="biryani img" className="max-w-[430px] w-full mx-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)]" />
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                <div>
                  <button className="bg-gradient-to-r bg-yellow-400 text-white to-secondary py-2 px-4 rounded-full shadow-xl hover:shadow-md">Order Now</button>
                </div>
              </div>
            </div>
          </div>
